# Adapted from https://github.com/JiuhaiChen/BLIP3o/blob/BLIP3o-NEXT/tok/mm_autoencoder.py
...
class MMAutoEncoder(nn.Module):
    def __init__(
        self, ar_path, encoder_path, decoder_path, encoder_args={}, decoder_args={}
    ):
        super().__init__()
        self.ar_model = ARModel.from_checkpoint(ar_path)

        self.encoder = TextAlignedTokenizer.from_checkpoint(
            encoder_path, load_teacher=False, **encoder_args
        )
