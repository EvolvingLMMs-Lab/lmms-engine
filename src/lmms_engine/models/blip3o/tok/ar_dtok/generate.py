# Copied from https://github.com/JiuhaiChen/BLIP3o/blob/BLIP3o-NEXT/tok/ar_dtok/generate.py
...
def generate(
    ...
    **sampling_kwargs,
    ...
    if model.frame_prediction:
        assert (
            cfg_scale == 1.0
        ), "frame prediction requires cfg_scale=1.0 (no classifier-free guidance)"
        cond_combined = cond
        T = cond.shape[1]
