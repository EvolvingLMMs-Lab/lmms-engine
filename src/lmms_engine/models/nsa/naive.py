...
# NSA copied from https://github.com/fla-org/native-sparse-attention/blob/main/native_sparse_attention/ops/parallel.py
# Change the window size attention with fa2
...
def naive_nsa_compression_varlen(
    ...
    for i in range(len(cu_seqlens) - 1):
        ...
        block_indices[0][
            cu_seqlens[i] : cu_seqlens[i + 1], :, :S_b
