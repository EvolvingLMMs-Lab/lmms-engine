...
class Qwen3_5DataProcessor(BaseQwen2_5_DataProcessor):
    ...
    def process(
        ...
        **kwargs,
        ...
        assert audios is None, "Qwen3_5DataProcessor does not support audio"
    ...
    def get_qwen_template_labels(
        ...
        for message in hf_messages:
            ...
            if self.video_token_id in encode_id:
                # Qwen3.5 inherits Qwen3 VL video timestamp logic
